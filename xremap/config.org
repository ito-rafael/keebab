...
| binding | description                            |
|---------+----------------------------------------|
| FN_F1   | switch xremap mode {default,lan-mouse} |
| FN_F2   | host control with MX Master 3 mouse    |
|---------+----------------------------------------|
...
#+begin_src conf :noweb-ref cpc-default
  - name: copy/paste/cut - general
    application:
      not: [Emacs, "/emacs.*/", libreoffice-calc, edge_bottom]
    remap:
      F16: Ctrl-x
      F17: Ctrl-c
      F18: Ctrl-v
