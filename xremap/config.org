...
print('  - name: miscellaneous text - currency & symbol (terminal)')
print('    application:')
...
print('      Alt_R-q: { launch: ["' + ipc_cmd + '", "exec", "sleep 0.1 && echo -n \\"⌀\\"  | ' + copy_cmd + ' && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }')
#+end_src
*** Currency & symbol
