...
(deflayer window-manager
  @klw @klt @fsc @lck @flt      _    @ofl @wsn @wsp @ofr      _  _  _
  @res @sag @spy @spw @ter      _    @wfl @wfd @wfu @wfr      _  _  _
  @spl @emx @cpy @pst _         @spu @spa @sp1 @sp2 @sp3      _  _  _
...
(deflayer mouse
  ...
  @hm  XX   @trl @llm @hra      XX   @mcl @mcd @mcu @mcr      _  _  _
