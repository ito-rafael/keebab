...
#+begin_src kbd
(deflayer number
  [    4    5    6    ]         @vp0 @vp1 @vp2 @vp3 @vp4      _  _  _
...
(defalias
  ...
  ans A-M-k  ;; ansible-provision

  ;; VPNs
  vp0 M-A-0  ;; connect to VPN #0: Proton VPN
...
(deflayer symbol
  ...
  grv  @&   @*   @lp  \         @the @wsp @btp @btn @wsn      _  _  _
            _    @rp  @|        _    XX   XX                  _  _  _
                                                              _  _  _
)
#+end_src
...
(defalias
  ...
  the M-S-t  ;; toggle system theme via gsettings
...
(deflayer window-manager
  ...
  @spl @emx @cpy @pst @pac      @sps @sp1 @sp2 @sp3 @spu      _  _  _
...
(defalias
  ...
  spu M-/  ;; scratchpad Keymapp

  pom M-j  ;; pomodoro timer
  lms M-m  ;; lan-mouse switch
  sps M-k  ;; scratchpad scrcpy
...
(deflayer navigation
  ...
  @mwp @hn1 @hn2 @hn3 @mwn      @cap left down up   rght      _  _  _
...
(deflayer mouse
  ...
  @ren @ema @trl @llm @hra      XX   @mcl @mcd @mcu @mcr      _  _  _
  XX   XX   XX   @wtf @aur      XX   @mwl @mwd @mwu @mwr      _  _  _
...
(defalias
  ...
  wtf A-M-d  ;; weather forecast (Mousam)
  aur A-M-v  ;; AUR update (Arch Linux)
  ...
  ;; scratchpads
  ema (tap-hold-release $mt $mt M-A-r lalt)                  ;; email client (Betterbird)
...
(deflayer misc
  ...
  @sla @cyr @mst @mnh @mca      @me4 @me1 @cye @mid @slo      _  _  _
  _    _    @mzc @mpn _         @mn2 @mnm _    _    _         _  _  _
            _    _    _         _    _    _                   _  _  _
                                                              _  _  _
)
#+end_src
