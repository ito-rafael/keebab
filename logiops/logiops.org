...
Modern Linux kernels (=hid-logitech-dj= driver) and =libinput= have native support for the MX Master 3's high-resolution scrolling (don't need to use LogiOps for this anymore).
